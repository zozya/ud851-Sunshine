...
//      DONE (4) Replace the weatherSummary TextView with individual weather detail TextViews
        final TextView mDayInfo;
        final TextView mWeatherDescr;
...
//          DONE (6) Get references to all new views and delete this line
            ...
            mDayInfo = (TextView) view.findViewById(R.id.day_info);
            mWeatherDescr = (TextView) view.findViewById(R.id.weather_descr);
